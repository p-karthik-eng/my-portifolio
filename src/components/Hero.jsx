...
const Hero = () => {
  return (
    <div className="bg-[#0f0b1d] min-h-screen flex items-center justify-center px-4 sm:px-6 relative font-preahvihear mt-10 ">
      <div className="text-center relative">
        ...
        <div>  Hello! I Am{" "}
        <span className="text-purple-500 font-semibold">Karthik Putcha</span></div>
        </div>
  ...
  className="
    ...
    hidden sm:block      /* Hide on mobile, show from sm and above */
    md:absolute md:top-[-140px] md:right-[-40px] /* Medium Screen Alignment */
    lg:absolute lg:top-[-150px] lg:right-[-100px] /* Large Screen Alignment */
    z-0
  "
/>
          ...
          <div className="text-center md:text-left">
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white font-bold mt-2">
              ...
              <span className="relative text-purple-500">
                cover
                <span className="absolute -bottom-1 left-0 w-full h-1 bg-purple-500"></span>
              </span>
              ...
            </h1>
